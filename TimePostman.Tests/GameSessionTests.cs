...
namespace TimePostman.Tests
{
    ...
    public class GameSessionTests
    {
        ...
        public void Game_Wins_When_All_Orders_Are_Delivered()
        {
            ...
            Assert.AreEqual(DeliveryAttemptResult.Delivered, session.TryDeliver(6));
            Assert.AreEqual(DeliveryAttemptResult.Delivered, session.TryDeliver(9));
            ...
            Assert.AreEqual(DeliveryAttemptResult.Delivered, session.TryDeliver(7));
            ...
            Assert.AreEqual(DeliveryAttemptResult.Delivered, session.TryDeliver(8));
